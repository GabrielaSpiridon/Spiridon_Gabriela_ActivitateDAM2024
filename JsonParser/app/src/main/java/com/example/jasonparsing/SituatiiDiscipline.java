...
public class SituatiiDiscipline {
    ...
    public SituatiiDiscipline(String disciplina, String activitate, int valoare, double pondere, String data, String descriere) {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("SituatiiDiscipline{");
